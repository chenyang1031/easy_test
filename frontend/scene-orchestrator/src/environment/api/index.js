...
export const environmentApi = {
  ...
  get: (id) => request(`/api/v1/environments/${id}/`),
  create: (data) => request('/api/v1/environments/', { method: 'POST', body: JSON.stringify(data) }),
  update: (id, data) => request(`/api/v1/environments/${id}/`, { method: 'PUT', body: JSON.stringify(data) }),
  remove: (id) => request(`/api/v1/environments/${id}/`, { method: 'DELETE' }),
}
